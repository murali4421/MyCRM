  ...
  template: `
     <header class="h-16 bg-gray-800 border-b border-gray-700 flex items-center justify-between px-4 sm:px-6">
        ...
        <div class="flex items-center space-x-1 sm:space-x-4">
            <!-- Notification Center -->
            <div class="relative">
                <button (click)="toggleNotificationCenter()" class="relative p-2 rounded-full hover:bg-gray-700 text-gray-400">
                    ...
                    @if (notificationService.unreadCount() > 0) {
                        <span class="absolute top-1.5 right-1.5 block h-2.5 w-2.5 rounded-full bg-indigo-500 ring-2 ring-gray-800"></span>
                    }
                </button>
            ...
            <!-- Profile Menu -->
            <div class="relative">
                <button (click)="toggleProfileMenu()" class="w-9 h-9 rounded-full bg-gray-700 flex items-center justify-center font-bold text-gray-200">
