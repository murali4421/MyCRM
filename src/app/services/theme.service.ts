...
export class ThemeService {
  readonly themes: Themes = {
    ...
    'sales-dashboard': {
      ...
      'bg-secondary': 'bg-slate-100',
      'bg-secondary-hover': 'hover:bg-slate-200',
      'bg-tertiary': 'bg-teal-800',
      'bg-contrast': 'bg-slate-900',
      'bg-inverted': 'bg-slate-800',
      'bg-disabled': 'bg-slate-400',
      'bg-transparent': 'bg-transparent',
      'bg-transparent-hover': 'hover:bg-white/10',
      ...
      'text-contrast-secondary': 'text-teal-200',
      'text-contrast-tertiary': 'text-teal-300',
      'placeholder-text': 'placeholder:text-slate-400',
      ...
      // Accent Colors (Teal from image)
      'bg-accent': 'bg-teal-600',
      'hover:bg-accent-hover': 'hover:bg-teal-700',
      'text-accent': 'text-teal-600',
      'hover:text-accent-hover': 'hover:text-teal-700',
      'border-accent': 'border-teal-500',
      'focus:ring-accent': 'focus:ring-teal-500',
      'focus:border-accent': 'focus:border-teal-500',
      'focus:ring-accent-subtle': 'focus:ring-teal-500/50',
      'bg-accent-subtle': 'bg-teal-100',
      'hover:bg-accent-subtle-hover': 'hover:bg-teal-200/50',
      'text-accent-subtle': 'text-teal-800',
      'ring-accent': 'ring-teal-500',
      ...
      'bg-warning-subtle': 'bg-orange-500/10',
      'border-warning-subtle': 'border-orange-500/20',
      'text-info': 'text-sky-600',
      'bg-info-subtle': 'bg-sky-500/10',
      'text-special': 'text-violet-600',
      'bg-special-subtle': 'bg-violet-500/10',
      'ring-base-for-notifications': 'ring-teal-800',
      'gradient-from-primary': 'from-white',
      'text-on-accent': 'text-white',
    },
    'midone-light': {
